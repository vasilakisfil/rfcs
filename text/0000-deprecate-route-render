...
- Deprecation Guide: (leave this empty)

# Summary

We would like to deprecate `Route#renderTemplate` and `Route#render`, as there are currently better APIs to accomplish the same functionality.
